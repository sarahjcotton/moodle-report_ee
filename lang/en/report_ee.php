...
$string['helplevel_help'] = 'Where the standards set for the assessment appropriate for their level?';
...
$string['helpnational_help'] = 'Were the standards of student performance comparable with similar programmes or subjects in other UK institutions with which you are familiar?';
$string['level'] = 'Level';
